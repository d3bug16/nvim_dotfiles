...
--save
keymap.set('n', "<leader>e", ":w<CR>", { desc = "save current buffer" })
keymap.set('n', "<leader>ee", ":wa<CR>", { desc = "save all buffer" })
keymap.set("n", "<leader>E", ":wqa<CR>", { desc = "save all buffer and close neovim" })
--searching files and word using grep
keymap.set('n', 'ss', require('telescope.builtin').find_files, { desc = 'searching file' })
...
---------------- telescope
keymap.set('n', 'e', '<cmd>:NvimTreeOpen<CR>', { desc = "open nvim-tree" })
keymap.set('n', 'E', '<cmd>:NvimTreeClose<CR>', { desc = "close nvim-tree" })
---------------- coding
--desable autocompletion
keymap.set('n', '<leader>cp', ':lua require("cmp").setup.buffer { enabled = false }<CR>', { desc =
"desable all completion" })
keymap.set('n', '<leader>cs', ':lua require("cmp").setup.buffer { enabled = true }<CR>', { desc = "enable all completion" })
--formating
